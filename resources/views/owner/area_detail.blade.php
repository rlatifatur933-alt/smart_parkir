    ...
    <div class="row mb-4">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1">
                        <i class="fas fa-map-marker-alt me-2" style="color: #8b5cf6;"></i>{{ $area->nama_area }}
                    </h2>
                    <p class="text-muted mb-0">Detail aktivitas dan pendapatan area parkir</p>
                </div>
...
<style>
    ...
    a[href="{{ route('owner.dashboard') }}"]:hover {
